    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("device.wifiDevices")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="address" :label="$t('device.address')"></el-table-column>
          <el-table-column prop="admin" :label="$t('device.admin')"></el-table-column>
          <el-table-column prop="password" :label="$t('device.password')"></el-table-column>
          <el-table-column prop="brand_id" :label="$t('device.brand_id')"></el-table-column>
          <el-table-column prop="asset_type" :label="$t('device.asset_type')"></el-table-column>
          <el-table-column prop="asset_number" :label="$t('device.asset_number')"></el-table-column>
          <el-table-column prop="device_model_id" :label="$t('device.device_model')"></el-table-column>
          <el-table-column prop="area" :label="$t('device.area')"></el-table-column>
          <el-table-column prop="status" :label="$t('device.status')" width="120">
