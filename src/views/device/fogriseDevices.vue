    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("device.fogriseDevices")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="category" :label="$t('device.category')"></el-table-column>
          <el-table-column prop="type" :label="$t('device.type')"></el-table-column>
          <el-table-column prop="area" :label="$t('device.area')"></el-table-column>
          <el-table-column prop="device_x" :label="$t('device.device_x')"></el-table-column>
          <el-table-column prop="device_y" :label="$t('device.device_y')"></el-table-column>
