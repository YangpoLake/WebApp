    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("device.devicesDocs")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="device_model_id" :label="$t('device.device_model')"></el-table-column>
          <el-table-column prop="instruction_manual_file" :label="$t('device.instruction_manual_file')"></el-table-column>
          <el-table-column prop="instruction_manual" :label="$t('device.instruction_manual')"></el-table-column>
          <el-table-column prop="maintenance_manual_file" :label="$t('device.maintenance_manual_file')"></el-table-column>
          <el-table-column prop="maintenance_manual" :label="$t('device.maintenance_manual')"></el-table-column>
          <el-table-column prop="emergency_treatment_file" :label="$t('device.emergency_treatment_file')"></el-table-column>
          <el-table-column prop="emergency_treatment" :label="$t('device.emergency_treatment')"></el-table-column>
          <el-table-column prop="created_at" :label="$t('device.created_at')" width="180">
