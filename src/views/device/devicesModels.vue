    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("device.devicesModels")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="name" :label="$t('device.name')"></el-table-column>
          <el-table-column prop="device_type" :label="$t('device.device_type')"></el-table-column>
          <el-table-column prop="devices_id" :label="$t('device.devices_id')"></el-table-column>
          <el-table-column prop="brands_id" :label="$t('device.brands_id')"></el-table-column>
          <el-table-column prop="responsible" :label="$t('device.responsible')"></el-table-column>
          <el-table-column prop="maintenance_cycle" :label="$t('device.maintenance_cycle')"></el-table-column>
