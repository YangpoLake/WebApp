    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("device.lightDevices")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="light_x" :label="$t('device.light_x')"></el-table-column>
          <el-table-column prop="light_y" :label="$t('device.light_y')"></el-table-column>
