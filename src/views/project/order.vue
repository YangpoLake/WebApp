    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("project.order")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="amount" :label="$t('project.amount')"></el-table-column>
          <el-table-column prop="paid_through" :label="$t('project.paid_through')"></el-table-column>
          <el-table-column prop="out_sn" :label="$t('project.out_sn')"></el-table-column>
          <el-table-column prop="status" :label="$t('project.status')"></el-table-column>
          <el-table-column prop="product_detail" :label="$t('project.product_detail')"></el-table-column>
          <el-table-column prop="appointmentd_at" :label="$t('project.appointmentd_at')"></el-table-column>
          <el-table-column prop="paid_at" :label="$t('project.paid_at')"></el-table-column>
          <el-table-column prop="used_at" :label="$t('project.used_at')"></el-table-column>
          <el-table-column prop="created_at" :label="$t('project.created_at')"></el-table-column>
          <el-table-column prop="customer" :label="$t('project.customer')"></el-table-column>
          <el-table-column prop="product" :label="$t('project.product')"></el-table-column>
        </el-table>
        <el-pagination
