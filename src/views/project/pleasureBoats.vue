    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("project.pleasureBoats")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="numbering" :label="$t('project.numbering')"></el-table-column>
          ...
          <el-table-column prop="brand" :label="$t('project.brand')"></el-table-column>
