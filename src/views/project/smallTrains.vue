    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("project.smallTrains")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="type" :label="$t('project.type')"></el-table-column>
          <el-table-column prop="group" :label="$t('project.group')"></el-table-column>
          <el-table-column prop="photo" :label="$t('project.photo')"></el-table-column>
          <el-table-column prop="passengers" :label="$t('project.passengers')"></el-table-column>
          <el-table-column prop="power_form" :label="$t('project.power_form')"></el-table-column>
