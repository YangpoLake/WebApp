    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("project.product")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="category" :label="$t('project.category')"></el-table-column>
          <el-table-column prop="title" :label="$t('project.title')"></el-table-column>
          <el-table-column prop="image_url" :label="$t('project.image_url')"></el-table-column>
          <el-table-column prop="price" :label="$t('project.price')"></el-table-column>
          <el-table-column prop="market_price" :label="$t('project.market_price')"></el-table-column>
          <el-table-column prop="quantity" :label="$t('project.quantity')"></el-table-column>
          <el-table-column prop="sum_price" :label="$t('project.sum_price')"></el-table-column>
          <el-table-column prop="is_online" :label="$t('project.is_online')"></el-table-column>
          <el-table-column prop="sort" :label="$t('project.sort')"></el-table-column>
          <el-table-column prop="details" :label="$t('project.details')"></el-table-column>
