    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("project.brands")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="photo" :label="$t('project.photo')" width="120"></el-table-column>
          <el-table-column prop="brand_category" :label="$t('project.brand_category')"></el-table-column>
          <el-table-column prop="supplier" :label="$t('project.supplier')" width="180"></el-table-column>
