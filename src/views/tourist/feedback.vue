  ...
  <div class="page-container">
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("tourist.feedback")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        <!-- "category": 1,
            "content": "我要评论，xxxx",
            "created_at": "2020-07-15 15:23:25",
            "updated_at": "2020-07-15 15:23:25",
            "customer": {
                "id": 1,
                "name": "top1",
                "mobile_number": "18700000000",
                "avatar_url": null,
                "last_login_at": "2020-07-16 13:34:41",
                "created_at": "2020-07-11 00:24:11",
                "updated_at": "2020-07-16 13:34:41"
            } -->
          <el-table-column type="selection" width="55"></el-table-column>
          <el-table-column prop="category" :label="$t('tourist.category')"></el-table-column>
          <el-table-column prop="content" :label="$t('tourist.content')"></el-table-column>
          <el-table-column prop="customer" :label="$t('tourist.customer')"></el-table-column>
