    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("tourist.tourist")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="name" :label="$t('tourist.name')"></el-table-column>
          <el-table-column prop="mobile_number" :label="$t('tourist.mobile_number')"></el-table-column>
          <el-table-column prop="avatar_url" :label="$t('tourist.avatar_url')"></el-table-column>
          <el-table-column prop="last_login_at" :label="$t('tourist.last_login_at')"></el-table-column>
