    ...
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="title" :label="$t('tourist.title')"></el-table-column>
          <el-table-column prop="images_url" :label="$t('tourist.images_url')"></el-table-column>
          <el-table-column prop="url" :label="$t('tourist.url')"></el-table-column>
          <el-table-column prop="is_show" :label="$t('tourist.is_show')"></el-table-column>
