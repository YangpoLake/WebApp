    ...
    <div class="page-header">
      <el-page-header @back="goBack">
        <template slot="content">
          ...
          <span>{{this.$t("user.permission")}}</span>
        </template>
      </el-page-header>
    </div>
    <div class="page-content">
      <div class="container" style="flex-grow: 1;">
        ...
        >
          ...
          <el-table-column prop="type" :label="$t('user.type')"></el-table-column>
          <el-table-column prop="guard_name" :label="$t('user.guard_name')"></el-table-column>
          <el-table-column prop="display_name" :label="$t('user.display_name')"></el-table-column>
          <el-table-column prop="route" :label="$t('user.route')"></el-table-column>
          <el-table-column prop="icon" :label="$t('user.icon')"></el-table-column>
          <el-table-column prop="sort" :label="$t('user.sort')"></el-table-column>
          <el-table-column prop="created_at" :label="$t('user.created_at')"></el-table-column>
          <el-table-column prop="updated_at" :label="$t('user.updated_at')"></el-table-column>
